[
   ...
   Assignment                         -- H[KW["("]_1 KW[")"] KW[":="] KW["("]_2]KW[")"],
   ...
   ThisCall                           -- H hs=0[KW["("]_1 KW["("] H[_2] KW[")"] KW[")"]],
   ThisCall.2:iter-star-sep           -- H hs=0[_1 KW[","]],
   Call                               -- H hs=0[KW["("]_1 KW["."] _2 KW["("] H[_3] KW[")"]]KW[")"],
   Call.3:iter-star-sep               -- H hs=0[_1 KW[","]],
   InColl                             -- H hs=0[KW["("]_1 KW[")"] KW["in"] KW["("]_2 KW[")"] ],
   Eq                                 -- H[KW["("]_1 KW["=="] _2 KW[")"]],
   NotEq                              -- H[KW["("]_1 KW["!="] _2 KW[")"]],
   LargerThan                         -- H[KW["("]_1 KW[">"] _2 KW[")"]],
   LargerThanOrEqual                  -- H[KW["("]_1 KW[">="] _2 KW[")"]],
   SmallerThan                        -- H[KW["("]_1 KW["<"] _2 KW[")"]],
   SmallerThanOrEqual                 -- H[KW["("]_1 KW["<="] _2 KW[")"]],
   Add                                -- H[KW["("]_1 KW["+"] _2 KW[")"]],
   Sub                                -- H[KW["("]_1 KW["-"] _2 KW[")"]],
   Mul                                -- H[KW["("]_1 KW["*"] _2 KW[")"]],
   Mod                                -- H[KW["("]_1 KW["%"] _2 KW[")"]],
   Div                                -- H[KW["("]_1 KW["/"] _2 KW[")"]],
   And                                -- H[KW["("]_1 KW["&&"] _2 KW[")"]],
   Or                                 -- H[KW["("]_1 KW["||"] _2 KW[")"]],
   Not                                -- H[KW["("] KW["!"] _1 KW[")"]],
   IsA                                -- H[KW["("] _1 KW["is"] KW["a"] _2 KW[")"] ],
   ...
   Paren                                        -- KW["("] _1 KW[")"],
   Paren.1:iter-sep                             -- _1 KW[","],
   Indices                                      -- KW["("] KW["indices"] KW["("] _1 KW[")"]KW[")"],
   InCollectionElements                         -- _1 KW["in"] KW["elements"] KW["("] _2 KW[")"],
   Elements                                     -- KW["("] KW["elements"] KW["("] _1 KW[")"] KW[")"],
   Sum                                          -- KW["("] KW["sum"] KW["("] _1 KW[")"] KW[")"],
   NumParam                                     -- _1,
   IdParam                                      -- _1,
   AjaxActionIdParam                            -- _1 _2 KW["<<"] _3 KW[";"],
   UMinus                                       -- KW["-"] _1,
   Divide                                       -- KW["("] _1 KW["/"] _2 KW[")"],
   Multiply                                     -- KW["("] _1 KW["*"] _2 KW[")"],
   Minus                                        -- KW["("] _1 KW["-"] _2 KW[")"],
   UMinus                                       -- KW["-"] _1,
   Plus                                         -- KW["("] _1 KW["+"] _2 KW[")"],
   ProcPlus                                     -- _1 KW["+"] _2,
   Concat                                       -- KW["("] _1 KW["||"] _2 KW[")"],
   ...
   LT                                           -- KW["("]_1 KW["<"] _2,
   GT                                           -- KW["("]_1 KW[">"] _2,
   NOTLIKE                                      -- KW["("]_1 KW["not"] KW["like"] _2,
   LIKE                                         -- KW["("]_1 KW["like"] _2,
   NOTLIKE                                      -- KW["("]_1 KW["not"] KW["like"] _2,
   SQLNE                                        -- KW["("]_1 KW["<>"] _2,
   NE                                           -- KW["("]_1 KW["!="] _2,
   SQLNE                                        -- KW["("]_1 KW["<>"] _2,
   IS                                           -- KW["("]_1 KW["is"] _2,
   EQ                                           -- KW["("]_1 KW["="] _2,
   QueryNot                                     -- KW["("]KW["not"] _1,
   QueryAnd                                     -- KW["("]_1 KW["and"] _2,
   QueryOr                                      -- KW["("]_1 KW["or"] _2,
   AliasedExpression.2:opt                      -- KW["("]_1,
...
%% Webdsl-Regex
   ...
   CountStar                                              -- KW["("] KW["count"] KW["("] KW["*"] KW[")"] KW[")"],
   Count                                                  -- KW["("] KW["count"] KW["("] _1 KW[")"] KW[")"],
   Max                                                    -- KW["("] KW["max"] KW["("] _1 KW[")"] KW[")"],
   Min                                                    -- KW["("] KW["min"] KW["("] _1 KW[")"] KW[")"],
   Avg                                                    -- KW["("] KW["avg"] KW["("] _1 KW[")"] KW[")"],
